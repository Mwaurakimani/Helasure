                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="mt-4 flex items-center">
                        ...
                        <label for="terms" class="ml-2 text-gray-700 text-sm">
                            I agree to the
                            <Link href="/Terms-0f-service" class="text-blue-500 font-semibold hover:underline">Terms of Service</Link>
                            and
                            <Link href="/Privacy-Policy" class="text-blue-500 font-semibold hover:underline">Privacy Policy</Link>
                            .
                        </label>
                    </div>
